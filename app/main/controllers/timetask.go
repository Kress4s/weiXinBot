...
// GetOne ...
// @Title Get One
// @Description get TimeTask by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.TimeTask
// @Failure 403 :id is empty
// @router /:id [get]
func (c *TimeTaskController) GetOne() {
	var v *bridageModels.TimeTask
	var err error
	...
	v, err = models.GetTimeTaskByID(id)
}

// GetAll ...
// @Title Get All
// @Description get TimeTask
...
// @Failure 403
// @router / [get]
func (c *TimeTaskController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, count, err := models.GetAllTimeTask(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = common.RestResult{Code: -1, Message: err.Error()}
	} else {
...
func (c *TimeTaskController) Put() {
	...
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.ParseInt(idStr, 0, 64)
	var v = bridageModels.TimeTask{ID: id}
	if err = json.Unmarshal(c.Ctx.Input.RequestBody, &v); err != nil {
		return
	}
	err = models.UpdateTimeTaskByID(&v)
}

// Delete ...
// @router /:id [delete]
func (c *TimeTaskController) Delete() {
	var err error
	defer func() {
		if err != nil {
			c.Data["json"] = common.RestResult{Code: -1, Message: err.Error()}
	...
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.ParseInt(idStr, 0, 64)
	err = models.DeleteTimeTaskByID(id)
}
...
func (c *TimeTaskController) GetAllTaksRecode() {
	...
	if manager = c.GetString("manager"); len(manager) == 0 {
